...
saveas(gcf,'results/task2p1_curve.fig','fig');
saveas(gcf,'results/task2p1_curve.png','png');
%% Evaluation 
rollout = 1000;
...
saveas(gcf,'results/task2p1_hist.fig','fig');
saveas(gcf,'results/task2p1_hist.png','png');
...
saveas(gcf,'results/task2p1_sample_trace.png','png');
saveas(gcf,'results/task2p1_sample_trace.fig','fig');
...
saveas(gcf,'results/task2p1_sample_trace_xyr.png','png');
saveas(gcf,'results/task2p1_sample_trace_xyr.fig','fig');
...
saveas(gcf,'results/task2p1_100traces.png','png');
saveas(gcf,'results/task2p1_100traces.fig','fig');
%% save data
save('results/task2p1Data',"Q","Log","Evaluation");