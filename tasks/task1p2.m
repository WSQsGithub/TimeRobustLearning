...
saveas(gcf,'results/task1p2_curve.fig','fig');
saveas(gcf,'results/task1p2_curve.png','png');
%% Evaluation 
rollout = 1000;
...
saveas(gcf,'results/task1p2_hist.fig','fig');
saveas(gcf,'results/task1p2_hist.png','png');
...
saveas(gcf,'results/task1p2_sample_trace.png','png');
saveas(gcf,'results/task1p2_sample_trace.fig','fig');
...
saveas(gcf,'results/task1p2_sample_trace_xyr.png','png');
saveas(gcf,'results/task1p2_sample_trace_xyr.fig','fig');
...
saveas(gcf,'results/task1p2_100traces.png','png');
saveas(gcf,'results/task1p2_100traces.fig','fig');
%% save data
save('results/task1p2Data',"Q","Log","Evaluation");